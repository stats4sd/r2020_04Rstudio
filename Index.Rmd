...
Rather than creating a new file from scratch right now, you can download the solutions from Module 1 as a workbook here [link]. And if you then open this up in RStudio you can get an idea of how the interface works. 
...
You can download the solutions for Module 2 in RMD format, and the data file used, in CSV format, here: [INSERT LINK]
...
![icon](img/ggplot2 not installed.jpg)
